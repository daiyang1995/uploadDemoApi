...
public class ZipCompressor {
	private static Logger logger = LoggerFactory.getLogger(ZipCompressor.class);
	...
	public void compressMutilExe(String[] srcPathName) {
	...
	public static void main(String[] args) {
		ZipCompressor zc = new  ZipCompressor("E:/xx.zip");  
        zc.compressExe("E:/xx");  
	}
}
